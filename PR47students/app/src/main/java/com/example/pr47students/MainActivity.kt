...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //registerReceiver(s2, filter.apply { priority = 900 })
        registerReceiver(s3, filter.apply { priority = 800 })
        registerReceiver(s4, filter.apply { priority = 700 })
        //registerReceiver(s5, filter.apply { priority = 600 })
        registerReceiver(s6, filter.apply { priority = 500 })
        //registerReceiver(s7, filter.apply { priority = 400 })
        registerReceiver(s8, filter.apply { priority = 300 })
        //registerReceiver(s9, filter.apply { priority = 200 })
    ...
    override fun onDestroy(){
       ...
       // unregisterReceiver(s7)
        unregisterReceiver(s8)
        //unregisterReceiver(s9)
